...
export type SortField = "name" | "accountNumber" | "bankNameAndBranch" | "ifscCode" | "createdAt";
...
const SORT_FIELDS: Array<{ field: SortField; label: string }> = [
  { field: "name", label: "Beneficiary Name" },
  { field: "accountNumber", label: "Account Number" },
  { field: "bankNameAndBranch", label: "Bank Name and Branch" },
