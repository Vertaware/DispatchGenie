...
import PaymentsViewToggle, { type ViewMode } from "./payments-view-toggle";
...
export default function PaymentsTableControls({
  selectedDate,
  onDateChange,
  onSort,
  onFilter,
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3">
      <div className="flex items-center gap-2">
        {onViewModeChange && <PaymentsViewToggle viewMode={viewMode} onChange={onViewModeChange} />}
        <Button
          onClick={onSort}
          variant="text"
          startIcon={
