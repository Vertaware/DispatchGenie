...
export type SortField = "soNumber" | "requestedAmount" | "transactionType" | "status" | "createdAt";
...
const SORT_FIELDS: Array<{ field: SortField; label: string }> = [
  { field: "soNumber", label: "Sales Order" },
  { field: "requestedAmount", label: "Transaction Amount" },
