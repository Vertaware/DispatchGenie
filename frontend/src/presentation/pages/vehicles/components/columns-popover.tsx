...
export const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { key: "driverPhone", label: "Driver Phone", sortField: "driverPhone" },
  {
    ...
    sortField: "shippingAmount",
    role: [UserRole.ADMIN, UserRole.ACCOUNTANT],
  },
  {
    key: "locationReachedAt",
    label: "Location Reached",
    sortField: "locationReachedAt",
  },
  { key: "unloadedAt", label: "Unloaded Date", sortField: "unloadedAt" },
  {
    key: "dbWaitingTimeHours",
    label: "DB Waiting Time",
    sortField: "dbWaitingTimeHours",
  },
