...
import type { SortOrder } from "~/infrastructure/services/sales-order.service";
...
const SORT_FIELDS: Array<{ field: SortField; label: string }> = [
  ...
  { field: "shippingAmount", label: "Vehicle Amount" },
  { field: "locationReachedAt", label: "Location Reached" },
  { field: "unloadedAt", label: "Unloaded Date" },
  { field: "dbWaitingTimeHours", label: "DB Waiting Time" },
