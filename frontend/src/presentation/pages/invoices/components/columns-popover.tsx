...
export const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { key: "vehicleNumber", label: "Vehicle Number", sortField: "vehicleNumber" },
  { key: "driverPhone", label: "Driver Phone", sortField: "driverPhone" },
  { key: "vehicleAmount", label: "Vehicle Amount", sortField: "vehicleAmount" },
  { key: "locationReachedAt", label: "Location Reached", sortField: "locationReachedAt" },
  { key: "unloadedDate", label: "Unloaded Date", sortField: "unloadedDate" },
  { key: "dbWaitingTime", label: "DB Waiting Time", sortField: "dbWaitingTime" },
  { key: "frightCost", label: "Fright Cost", sortField: "frightCost" },
  { key: "unloadingCharge", label: "Unloading Charge", sortField: "unloadingCharge" },
  { key: "detentionCharge", label: "Detention Charge", sortField: "detentionCharge" },
  { key: "otherExpense", label: "Other Expense", sortField: "otherExpense" },
  { key: "totalExpense", label: "Total Expense", sortField: "totalExpense" },
  { key: "profit", label: "Profit", sortField: "profit" },
];
