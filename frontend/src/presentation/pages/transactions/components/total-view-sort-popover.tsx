...
export type TotalViewSortField = "beneficiaryName" | "totalPaidAmount" | "remainingBalance";
...
const SORT_FIELDS: Array<{ field: TotalViewSortField; label: string }> = [
  ...
  { field: "totalPaidAmount", label: "Total Paid Amount" },
  { field: "remainingBalance", label: "Remaining Balance" },
];
