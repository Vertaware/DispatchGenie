...
import { IoCarOutline, IoDownloadOutline, IoFilter, IoGrid } from "react-icons/io5";
...
export default function SOTableControls({
  selectedDate,
  onDateChange,
  onSort,
  onFilter,
    ...
    <div className="flex items-center justify-between px-4 py-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button
          ...
          startIcon={<IoCarOutline className="size-4 text-gray-600" />}
        >
          <span className="text-sm capitalize text-gray-700">Assign Vehicle</span>
        </Button>
      </div>
    </div>
  );
